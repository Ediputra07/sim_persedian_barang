...
$query_terakhir = mysqli_query($conn, "
    SELECT nama_barang, jumlah, 
           ...
           tipe
    FROM (
        SELECT b.nama_barang, bm.jumlah_barang_masuk AS jumlah,
               bm.tanggal_masuk AS tanggal, 'Masuk' AS tipe
        FROM barang_masuk bm
        JOIN barang b ON bm.id_barang = b.id_barang
        WHERE bm.tanggal_masuk != '0000-00-00'
        UNION ALL
        SELECT b.nama_barang, bk.jumlah_barang_keluar AS jumlah,
               bk.tanggal_keluar AS tanggal, 'Keluar' AS tipe
        FROM barang_keluar bk
        JOIN barang b ON bk.id_barang = b.id_barang
        WHERE bk.tanggal_keluar != '0000-00-00'
    ) AS gabungan
            ...
            <tbody>
                <?php if (mysqli_num_rows($query_terakhir) > 0): ?>
                    ...
                    <tr>
                        ...
                        <td><?= $row['jumlah'] ?></td>
                        <td><?= htmlspecialchars($row['tanggal_format']) ?></td>
                        <td>
